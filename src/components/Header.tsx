    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <Button asChild className="bg-olive hover:bg-olive-dark text-warm-white rounded-full px-6">
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="bg-warm-white border-stone-200 w-[300px]">
              <div className="flex flex-col gap-8 mt-12">
                ...
                <Button asChild className="bg-olive hover:bg-olive-dark text-warm-white rounded-full w-full mt-4">
